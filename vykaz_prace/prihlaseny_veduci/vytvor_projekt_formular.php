...
<div id="container">
    ...
    <div class="Object1104"><span class="textstyle0">
        <h2><u>Vytváranie projektu</u></h2>
        <br></br>
            <form action="vytvor_projekt.php" method="post">
                <table>

                    <tr><td>Nazov:</td><td> <input type="text" name="nazov"/></td></tr>
                    <tr><td>Popis: </td><td><textarea name="popis" maxlength="1000" cols="25" rows="6"></textarea></td></tr>
                    <tr><td>Start projektu: </td><td><input type="date" value="<?php echo date('Y-m-d'); ?>" name="start_projektu" /></td></tr>
                    <tr><td>Koniec projektu: </td><td><input type="date" value="<?php echo date('Y-m-d'); ?>" name="koniec_projektu" /></td></tr>
