...
<div class="Object1104"><span class="textstyle0">
        ...
        <br></br>
        <a href="vytvor_projekt_formular.php"><a href="vytvor_projekt_formular.php"><img src="files/IMG_159.jpg"  alt=""></a></a>
        <br></br>
        <?php
        ...
        $result=mysqli_query($con, "SELECT * FROM projekt WHERE veduci='$id3' AND zamestnanec IS NULL ORDER BY nazov DESC LIMIT $pociatok, $limit") or die ("Spojenie s databázou bolo neúspešné");
        $num_results=mysqli_num_rows($result);
        echo "<table class='tabulka' border='0' width='600'>";
        echo "<tr><th>Projekt</td><th>Zaciatok</td><th>Koniec</td><th></td><th></td><th></td></tr>";
